...
if(typeof option=='string')data[option]()})}
$.fn.shift.Constructor=Shift}(jQuery);
+function($){
//     "use strict";var Bjax=function(element,options){this.options=options
